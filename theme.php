...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
   ...
   <div class="tm-toolbar uk-clearfix">
        ...
        <div class="uk-container uk-container-center">
            <div class="tm-navbar-center">
                ...
                <div class="tm-nav-logo uk-hidden-small">
                    <a class="tm-logo uk-hidden-small" href="<?php echo $this['config']->get('site_url'); ?>"><img src="images/logo-crg.png" style="margin-top:-15px;" alt="CST" /></a>
                </div>
                <?php endif; ?>
    ...
    <div style=" background-image: none; width: 100%;">
	<?php echo $this['widgets']->render('fullscreen2'); ?>
    </div>
